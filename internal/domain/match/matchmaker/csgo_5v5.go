...
//
//import (
//	"cloudpvp-matcher/internal/domain/match"
//	"sort"
//	"time"
//
...
//
//var _ match.Matchmaker = (*CSGO5v5Matchmaker)(nil)
//
...
//func (m *CSGO5v5Matchmaker) FindMatch(pool []*ticket.Ticket, cfg *config.MatchConfig) *match.Match {
...
//func buildTeams(candidates []*ticket.Ticket, teamCount, teamSize int) ([]match.Team, bool) {
//	used := make([]bool, len(candidates))
//	teams := make([]match.Team, 0, teamCount)
//
...
//				used[idx] = true
//			}
//			teams = append(teams, match.Team{Tickets: ticketsAt(candidates, indexes)})
//
//			if search() {
//				return true
//			}
